    ...
    public class PersonaAdapter : Adapter
    {
        ...
        protected void Insert(Persona persona)
        {
            ...
            try
            {
                ...
                cmIns.Parameters.Add("@id_especialidad", SqlDbType.Int).Value = 9;
        ...
        public List<Persona> GetProfesores()
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmPErsona = new SqlCommand(" select * from personas where personas.id_especialidad != 9", SqlConn);
                SqlDataReader drPersona = cmPErsona.ExecuteReader();
        ...
        public List<Persona> GetAlumnos()
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmPErsona = new SqlCommand("select * from personas where personas.tipo_persona = 1", SqlConn);
                SqlDataReader drPersona = cmPErsona.ExecuteReader();
